...
This is the **source repository** for the KnowzCode framework — a platform-agnostic AI development methodology installed via plugin (`/plugin install knowzcode@knowz-skills`) or script (`npx @knowzai/knowzcode`).
