...
Generated by `/knowzcode:init`. Adapters should be placed in the project root (or platform-specific location).
...
.agents/agents/knowzcode-context-scout.md
...
```markdown
<!-- Generated by KnowzCode vX.Y.Z /knowzcode:init -->
...
Optionally generated by `/knowzcode:init` when Copilot is detected and MCP is configured:
