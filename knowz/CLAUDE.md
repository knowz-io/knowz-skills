...
- Prefer `amend_knowledge` for partial or targeted edits (user describes a delta); reserve `update_knowledge` for full replacements (user hands over the complete new payload).
